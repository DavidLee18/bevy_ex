...
use super::{components::Player, PLAYER_SPEED, PLAYER_SIZE};
...
pub fn spawn_player(
    ...
    commands.spawn((
        SpriteBundle {
            ...
            texture: assset_server.load("sprites/ball_blue_large.png"),
            ..default()
        },
        Player
    ));
...
pub fn confine_player_movement(mut player_query: Query<&mut Transform, With<Player>>, window_query: Query<&Window, With<PrimaryWindow>>) {
    if let Ok(mut player_transform) = player_query.get_single_mut() {
        ...
        let mut translation = &mut player_transform.translation;
